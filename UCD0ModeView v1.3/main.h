...
#define STEP_BUTTON_SWITCH			11
#define STEP_REPLUG_SWITCH			12
...
private:	// User declarations
	...
	bool    bModePass,bKeyBoardSwitch[5],bOtherSwitch[5];
	DWORD	dwModeIndex,dwNextModeIndex,dwResult,dwModeInit;
	DWORD   dwSwitchModeTimeOut[5],dwModeTimeOut[5],dwKeyBoardSwitchTimeOut[5],dwButtonSwitchTimeOut[5];
	DWORD	dwScreenResult;
	DWORD   dwModeCount;
	AnsiString astrPDVersion,astrNowPDVersion;
	AnsiString NETWORKCARD_MAC_CHECK[4],OtherSwitchMessage[5];
